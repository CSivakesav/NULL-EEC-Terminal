  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        id: 3,
        name: 'C Siva Kesav',
        role: 'Technical Head & Site Creator',
        department: 'CYBER',
        year: 'Final Year',
        avatar: '/Hackericon.jpg',
        bio: 'Technical Head and creator of the NULL EEC Terminal website. Leading cybersecurity projects and full-stack development initiatives.',
        skills: ['Full-Stack Development', 'Cybersecurity', 'React/Next.js', 'Terminal Design', 'Technical Leadership', 'Project Architecture'],
        github: 'https://github.com/CSivakesav',
        linkedin: 'https://linkedin.com/in/csivakesav'
      },
      {
        id: 4,
        name: 'Lavanya',
